# Design Doc: Adoção da Arquitetura de Microsserviços no SmartSensors

## 1. Visão Geral
Este documento de design detalha a adoção de uma arquitetura de microsserviços para a aplicação SmartSensors, monitoramento de sensores, composta por três serviços:
- Device Management
...
Foram identificadas e mapeadas duas principais capacidades de negócio para a aplicação SmartSensors:
- **Gestão de Sensores:**
...
Com base na entrevista com Carlos, CEO da SmartSensors, identificamos os principais problemas enfrentados pela empresa e como a arquitetura de microsserviços proposta pode resolvê-los.
...
- **Falta de Alertas de Oscilações de Temperatura:**
...
- **Falta de Histórico de Temperaturas:**
...
- **Configuração Manual e Descentralizada dos Sensores:**
...
## 6. Conclusão
A arquitetura de microsserviços proposta resolve os principais problemas identificados na entrevista com o CEO da SmartSensors, oferecendo uma solução escalável, resiliente e de fácil manutenção. Com a centralização de dados, alertas em tempo real, histórico de temperaturas e configuração unificada de sensores, a empresa estará melhor preparada para atender às necessidades dos clientes e crescer de forma sustentável.
